                ...
                <form action={submit}>
                    ...
                    <div className='row row-cols-1 row-cols-md-2'>
                        <div className='col'>
                            ...
                            <input name="firstname" type="text" className="form-control" id="exampleInputPassword1"/>
                        </div>
                        </div>
                        <div className='col'>
                            <div className="mb-3">
                            <label htmlFor="exampleInputPassword1" className="form-label">Nom :</label>
                            <input name="lastname" type="text" className="form-control" id="exampleInputPassword1"/>
                        </div>
                        </div>
                    </div>
                    ...
                    <div className="mb-3">
                        ...
                        <input name="phoneNumber" type="tel" className="form-control" id="exampleInputPassword1"/>
                    </div>
                    <div className="mb-3">
                        <label htmlFor="exampleInputPassword1" className="form-label">Message : </label>
                        <textarea name="textarea" id='textarea' className='form-control w-100' 
